...
<ul class="numbers__list">
    ...
    ?>
            <li id="<?=$this->GetEditAreaId($item['ID']);?>" class="nubmers__list-item">
                <label class="numbers__item-button number1">
                    <div class="numbers__item-check">
                        <input type="checkbox" class="numbers__checkbox-round">
                        <div class="numbers__checkbox-custom">
                        </div>
                    </div>
                    <span class="numbers__item-text"><?=$item['NAME']?></span>
                </label>
            </li>
    <?
        }
